...
@Controller
@RequestMapping("/profiles/{profileId}/edit")
...
public class EditProfiles {
    ...
    @Autowired
    public EditProfiles(ProfileRepository profileRepository) {
        this.profileRepository = profileRepository;
    }

    @RequestMapping(method = RequestMethod.GET)
    public String setupForm(@PathVariable("profileId") Long profileId, Model model) {
